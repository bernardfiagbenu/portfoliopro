...
export const metadata: Metadata = {
  ...
  description: 'A PhD-level proposal on using CRISPR gene-editing to address critical challenges in Ghana, from crop resilience to genetic diseases.',
};
    ...
    <div className="container mx-auto px-4 py-8">
      <SectionContainer title="CRISPR for Ghanaian Agriculture and Health" subtitle="A PhD-Level Proposal on Gene-Editing for Local Challenges">
        <div className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl mx-auto font-body text-foreground">
          ...
          <h3>Abstract</h3>
          <p>
            <strong>CRISPR-Cas9 gene-editing</strong> technology presents a powerful, precise, and relatively low-cost tool to address some of Ghana's most pressing challenges in agriculture and public health. This PhD proposal outlines a targeted research project focused on using CRISPR to enhance the resilience of a vital local crop, the cowpea (*Vigna unguiculata*), to drought and pests. This work serves as a model for building domestic capacity in advanced biotechnology, with a parallel focus on developing the ethical frameworks necessary for the responsible deployment of gene-editing technologies in Ghana.
          </p>
          ...
          <h3>Proposed PhD Research: A CRISPR-Edited Drought and Pest-Resistant Cowpea</h3>
          <p>
