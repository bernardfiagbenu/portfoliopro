...
const researchItems = [
   {
    ...
    title: 'Quantum Computing: Use Cases for Africa',
    description: 'A comprehensive analysis of future quantum computing use cases across major industries in Africa, including healthcare, finance, logistics, and agriculture. Read the full article.',
    date: 'Deep Dive Article',
    tags: ['Quantum', 'Africa', 'Development', 'Industry'],
    link: '/research/quantum-computing-use-cases',
  },
  {
    id: 'agi',
    title: 'Artificial General Intelligence (AGI) in Africa',
    description: 'Exploring how AGI can be developed to address continent-specific challenges like agricultural productivity and healthcare access.',
    date: 'Ongoing Exploration',
    tags: ['AI', 'AGI', 'Africa', 'Development'],
    link: '/research/artificial-general-intelligence', 
  },
  {
    id: 'quantum-computing',
    title: 'Quantum Computing for African Development',
    description: 'Investigating how to apply near-term quantum algorithms to solve complex optimization problems in African industries.',
    date: 'Ongoing Exploration',
    tags: ['Quantum', 'Optimization', 'Africa'],
    link: '/research/quantum-computing',
  },
  {
    id: 'bcis',
    title: 'BCIs for African Healthcare',
  ...
  {
    id: 'nanotech',
    title: 'Molecular Nanotechnology for African Challenges',
    description: 'Engineering low-cost molecular devices for field-deployable diagnostics for diseases relevant to Ghana and Africa.',
    date: 'Ongoing Exploration',
  ...
  },
  {
    ...
    date: 'Ongoing Exploration',
    tags: ['Energy', 'Fusion', 'Africa', 'Development'],
    link: '/research/fusion-energy',
  },
   {
    id: 'autonomous-vehicles',
    title: 'Autonomous Vehicles for African Logistics',
    description: 'Innovating in self-driving and aerial vehicles to transform transportation and supply chains across the continent.',
    date: 'Ongoing Exploration',
    tags: ['Autonomous', 'Mobility', 'Logistics', 'Africa'],
    link: '#',
  },
  {
    id: 'ar-vr',
    title: 'AR/VR for Education and Training in Africa',
    description: 'Creating immersive digital experiences to bridge gaps in education and vocational training across the continent.',
    date: 'Ongoing Exploration',
    tags: ['AR', 'VR', 'EdTech', 'Africa'],
    link: '#',
  },
  {
    id: 'crispr',
    title: 'CRISPR for African Agriculture and Health',
    description: 'Utilizing gene-editing to develop drought-resistant crops and new treatments for genetic diseases found in African populations.',
    date: 'Ongoing Exploration',
    tags: ['CRISPR', 'Genetics', 'Biotech', 'Africa'],
    link: '#',
  },
  {
    id: '3d-printing',
    title: '3D Printing for Local Manufacturing in Africa',
    ...
    date: 'Ongoing Exploration',
    tags: ['3D Printing', 'Manufacturing', 'Africa'],
    link: '#',
  },
  {
    id: 'space-tech',
    title: 'Space Technologies for African Development',
    description: 'Advancing technologies like satellite internet and remote sensing to improve connectivity, agriculture, and resource management.',
    date: 'Ongoing Exploration',
    tags: ['Space', 'Connectivity', 'Development', 'Africa'],
    link: '#',
  },
  {
    id: 'neuromorphic-computing',
    title: 'Neuromorphic Computing for Low-Power AI',
    description: 'Designing brain-inspired hardware for highly efficient AI that can run on low-power devices in off-grid African contexts.',
    date: 'Ongoing Exploration',
    tags: ['AI', 'Hardware', 'Edge AI', 'Africa'],
    link: '#',
  },
  {
    id: 'synthetic-biology',
    title: 'Synthetic Biology for African Challenges',
    description: 'Designing new biological systems to produce medicines, clean water, and sustainable materials locally.',
    date: 'Ongoing Exploration',
    tags: ['SynBio', 'Biotech', 'Africa'],
    link: '#',
  },
  {
    id: 'xenobots',
  ...
  {
    id: 'lab-grown-meat',
    title: 'Cellular Agriculture for Food Security in Africa',
    description: 'Developing sustainable and scalable protein sources through cell-based food production to improve food security.',
    date: 'Ongoing Exploration',
tags: ['Food Tech', 'Sustainability', 'Africa'],
    link: '#',
  },
  {
    id: 'vertical-farming',
    title: 'Vertical Farming for Urban Africa',
    description: 'Innovating in agriculture with technology-driven methods for efficient food production in rapidly growing African cities.',
    date: 'Ongoing Exploration',
    tags: ['AgriTech', 'Urban Farming', 'Africa'],
    link: '#',
  },
  {
    id: 'direct-air-capture',
    title: 'Direct Air Capture for Africa\'s Climate Future',
    description: 'Developing technologies to capture carbon dioxide, positioning Africa as a leader in the global carbon removal economy.',
    date: 'Ongoing Exploration',
    tags: ['Climate', 'Carbon Capture', 'Africa'],
    link: '/research/direct-air-capture',
  },
  {
    id: 'programmable-matter',
    title: 'Programmable Matter for African Infrastructure',
    description: 'Researching self-healing and adaptive materials to build resilient, low-cost infrastructure like roads and shelters.',
    date: 'Ongoing Exploration',
    tags: ['Materials', 'Infrastructure', 'Africa', 'Ghana'],
  ...
  },
  {
    ...
    title: 'Satellite Internet for Africa',
    description: 'Building satellite constellations and mesh networks to provide global, high-speed internet access to bridge the digital divide.',
    date: 'Ongoing Exploration',
    tags: ['Internet', 'Connectivity', 'Space', 'Africa'],
    link: '#',
  },
];
