...
const researchItems = [
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on developing robust, data-efficient, and causal AGI systems to address Ghana-specific challenges in agriculture and public health.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal investigating how to apply hybrid quantum-classical algorithms to solve complex optimization problems in Ghanaian industries like cocoa logistics.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on developing affordable, non-invasive Brain-Computer Interfaces for neurorehabilitation, focusing on a zero-calibration model for Ghanaian clinics.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal for engineering low-cost, thermally-stable DNA nanosensors for field-deployable diagnostics for diseases relevant to Ghana.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level perspective on how Ghana can strategically engage with global fusion R&D by focusing on niche areas like AI for plasma control and materials science.',
    date: 'PhD Perspective',
  ...
  },
   {
    ...
    description: 'A PhD-level proposal on innovating resilient, low-cost autonomous drones and ground vehicles to transform last-mile delivery and supply chains across Ghana.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on creating accessible, smartphone-based immersive digital experiences to bridge gaps in vocational education in Ghana.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on utilizing gene-editing to develop drought-resistant crops (cowpea) and new diagnostic tools for genetic diseases in Ghana.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on transforming manufacturing by using recycled plastic waste to enable local production of medical devices and spare parts.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on using satellite remote sensing and AI to monitor illegal mining (galamsey) and manage natural resources in Ghana.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on designing brain-inspired hardware for highly efficient AI that can run on low-power, off-grid devices for applications like crop disease detection.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on designing new biological systems to produce medicines, clean water, and sustainable materials locally in Ghana using cell-free systems.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on creating novel life-forms ("living robots") by assembling cells into functional, programmable organisms to understand biological construction.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on developing sustainable and scalable protein sources through cell-based food production to improve food security in Ghana.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on innovating in agriculture with low-energy, aquaponics-based vertical farming methods for efficient food production in Ghanaian cities.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on developing techno-economic models for solar-powered DAC in Ghana, positioning the nation as a leader in the carbon removal economy.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on researching self-healing and adaptive materials (from local resources) to build resilient, low-cost infrastructure in Ghana.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on expanding the concept of IoT to create a decentralized, privacy-preserving data framework for smart cities like Accra.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on advancing energy storage with safer, more efficient solid-state batteries, using locally-sourced minerals from Ghana.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal exploring the theoretical and computational neuroscience foundations of mind uploading by modeling neural circuits.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on investigating the biological mechanisms of aging to develop interventions, with relevance for Africa\'s growing elderly population.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on conceptualizing the search for Dyson Spheres and other technosignatures by mining astronomical data.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal exploring the ethical and policy dimensions of human augmentation, focusing on equitable access in a global context.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal investigating the theoretical physics and potential experimental signatures of warp drive spacetimes.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on creating synthetic life forms (A-Life) and protocells in simulation to understand the origins of life.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on developing methods for efficient, long-range wireless power transmission for off-grid applications in Ghana.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on researching low-temperature preservation, focusing on vitrification to enable organ banking for transplantation in Africa.',
    date: 'PhD Proposal',
  ...
  },
  {
    ...
    description: 'A PhD-level proposal on building decentralized community mesh networks to provide global, high-speed internet access to bridge the digital divide in Ghana.',
    date: 'PhD Proposal',
