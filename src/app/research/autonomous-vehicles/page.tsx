...
export const metadata: Metadata = {
  ...
  description: 'A PhD-level proposal on developing robust, low-cost autonomous ground and aerial vehicles for Ghana\'s unique logistical challenges.',
};
    ...
    <div className="container mx-auto px-4 py-8">
      <SectionContainer title="Autonomous Vehicles for Ghanaian Logistics" subtitle="A PhD-Level Proposal on Resilient and Low-Cost Autonomous Systems">
        <div className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl mx-auto font-body text-foreground">
          ...
          <h3>Proposed PhD Research: A Vision-Based SLAM for Last-Mile Drone Delivery</h3>
          <p>
